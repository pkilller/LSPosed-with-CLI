...
[Support CLI](https://github.com/LSPosed/LSPosed/pull/1593)

A developer([@yearsyan](https://github.com/yearsyan)) added cli support for [LSPosed](https://github.com/LSPosed/LSPosed), which allows us to manage modules, scopes via cli. However, after PR, the community considered it unsafe, so it was not merged into the master branch.
